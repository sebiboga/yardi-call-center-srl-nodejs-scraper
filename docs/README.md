...
**job_seeker_ro_spider** — scraper pentru job-urile YARDI din România.

Extrage anunțurile de pe [Yardi Romania Careers](https://yardiromania.breezy.hr) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
1. **Validează compania** — interoghează API-ul public ANAF ([demoanaf.ro](https://demoanaf.ro)) după CIF-ul YARDI (32509291) și verifică:
   - Denumirea oficială: YARDI CALL CENTER SRL
...
|---|---|---|
| Yardi Breezy | `https://careers.epam.com/api/jobs/v2/search/...` | Public |
...
Yardi Breezy [robots.txt](https://careers.epam.com/robots.txt) dezactivează:
...
# Doar E2E (API real Yardi + ANAF + SOLR)
npm run test:e2e
```
